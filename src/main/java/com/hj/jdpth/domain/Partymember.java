...
public class Partymember {
    ...
    private String pmiSex;

    private String pmiName;

    private Integer pmiNation;

    private String Nationname;

    private String zhuwu;
    ...
    public String getPmiSex() {
        return pmiSex;
    }

    public void setPmiSex(String pmiSex) {
        this.pmiSex = pmiSex;
    }
    ...
    public Integer getPmiNation() {
        return pmiNation;
    }

    public void setPmiNation(Integer pmiNation) {
        this.pmiNation = pmiNation;
    }
    ...
    public String getZhuwu() {
        return zhuwu;
    }

    public void setZhuwu(String zhuwu) {
        this.zhuwu = zhuwu;
    }
}